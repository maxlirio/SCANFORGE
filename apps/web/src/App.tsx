    ...
    <div className="app">
      ...
      {screen === 'example' && (
        <ResultView
          ...
          banner={'Example output — a real reconstruction this pipeline produced from 30 ' +
            'photographs of a stone statue. Bundled with the page so the viewer works ' +
            'without a server; it is not a scan you just made. Source photographs: ' +
            'AliceVision dataset_buddha, CC-BY-4.0.'}
